...
class EditTaskDialog extends StatefulWidget {
  ...
  const EditTaskDialog(
      {super.key, required this.onAddTask, required this.editTitleController});
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildTextField(widget.editTitleController, 'Task Title'),
              const SizedBox(height: 20),
      ...
      children: [
        ...
        ElevatedButton(
          onPressed: () {
            ...
            if (widget.editTitleController.text.isNotEmpty) {
              widget.onAddTask(
                TaskTile(
                  id: generatedId,
                  deleteOnPress: () {},
                  checkOnPress: () {},
                  title: widget.editTitleController.text,
