    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildFAQItem('How to create a task?', 'To create a task, tap on the "+" button on the home screen.'),
          _buildFAQItem('How to edit a task?', 'Double-tap on any task to edit it.'),
          _buildFAQItem('How to delete a task?', 'Swipe left on the task or tap on the delete icon to remove it.'),
          const Divider(),
          ...
          ListTile(
            ...
            onTap: () {
              // Implement email support functionality here
              _showSupportEmailDialog(context);
            },
          ),
          const Divider(),
          ...
          ListTile(
            ...
            onTap: () {
              // Implement tutorial video or walkthrough
          ...
          _buildFAQItem('App not syncing?', 'Try restarting the app or checking your internet connection.'),
          _buildFAQItem('Notifications not working?', 'Ensure notifications are enabled in settings and your device permissions.'),
          const Divider(),
          ListTile(
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: const Text('Please send an email to support@serenitytasks.com'),
          actions: [
            TextButton(
